...
def db_connect_and_grab():
    ...
    #print(f"User Data Row = {user_data_row}")
    user_current_balance = user_data_row[9] # Joining new user tables, shifts current balance idx.
    ...
    for i in range(len(monthly_bills)):
        monthly_bills[i] = rows[i][2]              # bill amts are index-2 elements of each row
